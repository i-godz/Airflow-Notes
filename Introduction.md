...
# Table of Contents
- [What is Airflow](#1--what-is-airflow)
	- [Benefits of Airflow](#11--benefits-of-airflow)
		- [Dynamic](#111--dynamic)
		- [Flexibility and Scalability](#112--flexibility-and-scalability)
		- [Fully Functional User Interface](#113--fully-functional-user-interface)
- [Airflow Components](#2--airflow-components)
	- [The Web Server](#21--the-web-server)
	- [The Scheduler](#22--the-scheduler)
	- [Meta Database](#23--meta-database)
	- [The Triggerer](#24--the-triggerer)
	- [The Executor](#25--the-executor)
	- [The Queue](#26--the-queue)
	- [The Worker](#27--the-worker)
- [Airflow Core Concepts](#3--airflow-core-concepts)
	- [The DAG (Directed Acyclic Graph)](#31--the-dag-directed-acyclic-graph)
	- [Operator](#32--operator)
	- [Tasks / Task Instances](#33--tasks--task-instances)
	- [Workflow](#34--workflow)
- [Different Architectures](#4--different-architectures)
	- [Single Node Architecture](#41--single-node-architecture)
	- [Multi Node Architecture](#42--multi-node-architecture)
- [DAG Execution Flow](#5--dag-execution-flow)
- [DAG Skeleton](#6--dag-skeleton)
	- [Basic DAG Code](#61--basic-dag-code)
	- [Creating a RDBMS Table](#62--creating-a-rdbms-table)
	- [Checking for API Availability](#63--checking-for-api-availability)
	- [Extract and Process Users](#64--extract-and-process-users)
- [Hooks](#7--hooks)
- [Datasets](#8--datasets)
	- [URI](#81--uri)
	- [Extra](#82--extra)

# Table of Contents
- [Benefits of Airflow](#benefits-of-airflow)
    - [Dynamic](#dynamic)
    - [Flexibility and Scalability](#flexibility-and-scalability)
    - [Fully Functional User Interface](#fully-functional-user-interface)
...
- [Airflow Core Concepts](#airflow-core-concepts)
    - [The DAG (Directed Acyclic Graph)](#the-dag-directed-acyclic-graph)
    - [Operator](#operator)
    - [Tasks / Task Instances](#tasks--task-instances)
    - [Workflow](#workflow)
...
- [DAG Skeleton](#dag-skeleton)
    - [Basic DAG Code](#basic-dag-code)

...
- [Airflow Components](#3--airflow-components)
    ...
    - [The Executor](#35--the-executor)
        - [Types of Executors](#351--types-of-executors)
            - [Sequential Executor](#3511--sequential-executor)
            - [Local Executor](#3512--local-executor)
            - [Celery Executor](#3513--celery-executor)
...
- [Airflow Core Concepts](#4--airflow-core-concepts)
    ...
    - [Operator](#42--operator)
        - [Types of Operators](#421--types-of-operators)
        - [Best Practices for Operators](#422--best-practices-for-operators)
...
- [DAG Skeleton](#7--dag-skeleton)
    - [Basic DAG Code](#71--basic-dag-code)
    - [Creating a RDBMS Table](#72--creating-a-rdbms-table)
    - [Checking for API Availability](#73--checking-for-api-availability)
    - [Extract and Process Users](#74--extract-and-process-users)
- [Hooks](#8--hooks)
- [Datasets](#9--datasets)
    - [URI](#91--uri)
    - [Extra](#92--extra)
